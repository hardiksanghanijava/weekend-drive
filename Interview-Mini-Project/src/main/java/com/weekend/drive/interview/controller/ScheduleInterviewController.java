...
import com.weekend.drive.interview.service.impl.ExportToExcelServiceImpl;
...
public class ScheduleInterviewController {
	...
	@Autowired
	private ExportToExcelServiceImpl exportToExcelServiceImpl;
	
	//Find All Data for Swagger
	@GetMapping(value="/v1/schedule")
	public ResponseEntity<?> getAllScheduleInterviewV1(){
	...
	//Find All Data by name for swagger
	@GetMapping(value="/v2/schedule")
	public ResponseEntity<?> getAllScheduleInterviewByNameV2(){
	...
	//Find Data By Id Dto
	@GetMapping("/schedule/dto/{id}")
	public ScheduleInterviewDto getScheduleInterviewDtoById(@PathVariable int id){
		return scheduleInterviewServiceImpl.getScheduleInterviewDtoById(id);
	}
    ...
    public ResponseEntity<?> excelCustomersReport() throws IOException {
        ...
        headers.add("Content-Disposition", "attachment; filename=ScheduleInterview.xlsx");
		
		return ResponseEntity
	                .ok()
	                .headers(headers)
	                .body(exportToExcelServiceImpl.export());
    }
