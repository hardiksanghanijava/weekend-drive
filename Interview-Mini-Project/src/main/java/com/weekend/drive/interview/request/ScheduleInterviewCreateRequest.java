...
public class ScheduleInterviewCreateRequest {
	...
	public static ScheduleInterviewDto toScheduleInterviewRequestEnttity(ScheduleInterviewCreateRequest scheduleInterviewCreateRequest) throws IllegalAccessException, InvocationTargetException {
		ScheduleInterviewDto scheduleInterviewDto = new ScheduleInterviewDto();
		BeanUtils.copyProperties(scheduleInterviewDto, scheduleInterviewCreateRequest);
